...
public class MesaRepositoryGatewayTest {
    ...
    @Test
    void deveGerarExcecao_RestauranteNaoEncontrado(){
        var idRestaurante = "1";
    ...
    @Test
    void deveGerarExcecao_ReservaSemStatusNaoEncontrada(){
        var idRestaurante = "1";
        var dataReserva = LocalDate.of(2024, 3, 20);
        var horaReserva = LocalTime.of(20, 0, 0, 0);
    ...
    @Test
    void deveGerarExcecao_ReservaComStatusNaoEncontrada(){
        var idRestaurante = "1";
        var dataReserva = LocalDate.of(2024, 3, 20);
        var horaReserva = LocalTime.of(20, 0, 0, 0);
        var statusMesa = StatusMesa.OCUPADA;
    ...
    @Test
    void deveGerarExcecao_ReservaNaoEncontrada(){
        var idReserva = "1";
    ...
    @Test
    void deveGerarExcecao_ReservaJaPossuiStatus(){
        var idReserva = "1";
        var status = StatusMesa.OCUPADA;
